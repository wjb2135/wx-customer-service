<template>
  <div class="history-table">
    <el-table
      ...
      size="mini"
    >
      <el-table-column prop="wx_appid_name" label="公众号名称" width="150"></el-table-column>
      <el-table-column prop="nickname" label="访客名称" width="100" show-overflow-tooltip></el-table-column>
      <el-table-column prop="custom_name" label="接待客服"></el-table-column>
      ...
      <el-table-column prop="source_name" label="会话来源" width="150"></el-table-column>
      <el-table-column prop="session_type" label="会话标签" width="150"></el-table-column>
      <el-table-column prop="custom_service" label="接待客服列表" width="150"></el-table-column>
      <el-table-column prop="chat_remark" label="会话备注" width="150"></el-table-column>
