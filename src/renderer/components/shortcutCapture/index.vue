<template>
  <div class="app">
    <background ref="background" :bounds="bounds"></background>
    <rectangle  ref="rectangle" :rect="rect" :bounds="bounds" @shift="shift" @resize="resize"></rectangle>
    <toolbar :rect="rect" @click="click"></toolbar>
  ...
  methods: {
    ...
    keyUpEnter () {
      ...
      window.addEventListener('keyup', e => {
        console.log(e)
        if (e.keyCode === 27) { // shift+enter做换行
          self.hide()
        }
      }, true)
    },
