  ...
  <div class="page-visitor-list">
    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column prop="weixin_account_name" label="公众号" width="100"></el-table-column>
        ...
        <el-table-column prop="sh_type" label="访客类型" width="150"  show-overflow-tooltip></el-table-column>
  ...
  methods: {
    ...
    sessionWindow (id) {
      if (this.hasCreatedSessionWin) {
        ...
        this.newWindows('/session/new?uid=' + id, {
          width: 900,
          height: 700,
          minWidth: 900,
          minHeight: 700,
